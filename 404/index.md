...
<meta name="twitter:card" content="summary">
        ...
        <link rel="alternate" type="application/atom+xml" title="Toby&#39;s Blog" href="/atom.xml">
  ...
  <div class="inner flex-row-vertical">
    ...
    <div class="brand-wrap" style="background-image:url(/img/brand.jpg)">
      <div class="brand">
        ...
        <hgroup class="introduce">
          <h5 class="nickname">Toby</h5>
          <a href="mailto:toby_lai@126.com" title="toby_lai@126.com" class="mail">toby_lai@126.com</a>
        </hgroup>
      </div>
    </div>
    <div class="scroll-wrap flex-col">
      <ul class="nav">
            ...
            <li class="waves-block waves-effect">
              <a href="https://github.com/programerTobyLai" target="_blank" >
...
(function() {
    ...
    document.addEventListener('visibilitychange', function() {
        if (document.hidden) {
            document.title = '啊啊啊啊，赶紧回来看文章';
            clearTimeout(titleTime);
        } else {
            document.title = 'O(∩_∩)O 终于回来了';
